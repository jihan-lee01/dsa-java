...
public class MSTAllHWTest {
    ...
    Graph getHouse() {
        ...
        quizgraph.setUndirectedEdge(0, 1, 1);
        quizgraph.setUndirectedEdge(0, 2, 1);
        quizgraph.setUndirectedEdge(0, 3, 1);
        quizgraph.setUndirectedEdge(1, 2, 1);
        quizgraph.setUndirectedEdge(1, 3, 1);
        quizgraph.setUndirectedEdge(2, 3, 1);
        quizgraph.setUndirectedEdge(1, 7, 1);
        quizgraph.setUndirectedEdge(0, 7, 1);
        quizgraph.setUndirectedEdge(0, 4, 1);
        quizgraph.setUndirectedEdge(3, 4, 1);
        quizgraph.setUndirectedEdge(1, 6, 1);
        quizgraph.setUndirectedEdge(6, 2, 1);
        quizgraph.setUndirectedEdge(5, 3, 1);
        quizgraph.setUndirectedEdge(5, 2, 1);
